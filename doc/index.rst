...
This subpackage contains classes and scripts related to data analysis. A simple source finder and shape
...
This folder contains the supporting data, such as cosmic ray distributions, cosmetics maps,
...
This folder contains a CDM03 CTI model Fortran code. For speed the model is in Fortran because it
...
A few postage stamps showing observed galaxies.


postproc
========

This subpackage contains methods related to either generating a CCD mosaics from simulated data
...
This subpackage contains a simple script to reduce VIS data. For more detailed documentation of the classes, please see:
...
This subpackage contains some support classes and methods related to generating log files and read in
data.
